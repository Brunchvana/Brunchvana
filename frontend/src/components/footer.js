...
//( includes contact info, small logo)
<footer style={"background-image:url(http://i.giphy.com/5lF3pQpdquCBy.gif);"} className="tc-l bg-center cover bg-red">
  <div className="w-100 ph3 pv5 bg-red-80">
